package org.sparta.aistudy.chatbot3.infrastructure;

import org.sparta.aistudy.chatbot3.application.LittlePrinceChatBotService;
...
@Service("littlePrinceChatbotService3")
public class LittlePrinceChatbotServiceImpl implements LittlePrinceChatBotService {

    private final ChatClient chatClient;

    public LittlePrinceChatbotServiceImpl(ChatClient.Builder builder, ChatMemory chatMemory) {
        chatClient = builder
                .defaultAdvisors(
