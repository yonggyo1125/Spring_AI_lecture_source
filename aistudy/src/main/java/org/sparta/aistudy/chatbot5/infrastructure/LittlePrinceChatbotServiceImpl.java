package org.sparta.aistudy.chatbot5.infrastructure;

import org.sparta.aistudy.chatbot5.application.LittlePrinceChatBotService;
...
@Service("littlePrinceChatbotService5")
public class LittlePrinceChatbotServiceImpl implements LittlePrinceChatBotService {

    private final ChatClient chatClient;

    public LittlePrinceChatbotServiceImpl(JdbcChatMemoryRepository chatMemoryRepository, ChatClient.Builder builder) {
